...
# W2V: sequence of kmers with Word2Vec
	...
	if search == 'search_mlp':
		search_MLP_models(all_mlp_models,train,valid,database,embedding_matrix,max_len,kmer_size,
			classes_1,classes_2,classes_3,classes_4,classes_5,classes_6)

	elif search == 'search_resnet':
		search_ResNet_models(all_resnet_models,train,valid,database,embedding_matrix,max_len,kmer_size,
			classes_1,classes_2,classes_3,classes_4,classes_5,classes_6)

	elif search == 'best_only':
		search_MLP_models(['MLP_SK'],train,valid,database,embedding_matrix,max_len,kmer_size,
			classes_1,classes_2,classes_3,classes_4,classes_5,classes_6)
	else:
